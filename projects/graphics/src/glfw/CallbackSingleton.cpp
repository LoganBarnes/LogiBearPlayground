                                             ...
                                             )
{
  ...
  Callback *callback = reinterpret_cast< Callback* >( glfwGetWindowUserPointer( pWindow ) );

  if ( callback )
  {

    callback->handleWindowSize( pWindow, width, height );
                                              ...
                                              )
{
  ...
  if ( callback )
  {
    ...
    callback->handleWindowFocus( pWindow, focus );
                                      ...
                                      )
{
  ...
  if ( callback )
  {
    ...
    callback->handleKey( pWindow, key, scancode, action, mods );
                                                 ...
                                                 )
{
  ...
  if ( callback )
  {
    ...
    callback->handleCursorPosition( pWindow, xpos, ypos );
                                              ...
                                              )
{
  ...
  if ( callback )
  {
    ...
    callback->handleMouseButton( pWindow, button, action, mods );
                                         ...
                                         )
{
  ...
  if ( callback )
  {
    ...
    callback->handleScroll( pWindow, xoffset, yoffset );
...
///
void
CallbackSingleton::setDefaultCallback( Callback *callback )
{
